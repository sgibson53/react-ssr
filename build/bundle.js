...
exports.default = [_extends({}, _App2.default, { // no path means it will always be displayed on the screen
    routes: [_extends({
        path: '/'
    }, _HomePage2.default, {
        exact: true
...
// Helper functions for babel, helps with async/await and other things
...
app.use('*', function (req, res) {
    ...
    var promises = (0, _reactRouterConfig.matchRoutes)(_Routes2.default, req.originalUrl).map(function (_ref) {
...
var Header = function Header(_ref) {
  ...
  var authButton = auth ? _react2.default.createElement(
    ...
    { href: '/api/logout' },
    'Logout'
  ) // Causes entire BROWSER to navigate
  : _react2.default.createElement(
    'a',
